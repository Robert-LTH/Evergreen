...
FunctionsToExport = @('Export-EvergreenFunctionStrings', 
               ...
               'Get-AdobeAcrobatReaderDC', 'Get-AdoptOpenJDK', 'Get-AdvancedInstaller', 
               ...
               'Get-ControlUpAgent', 'Get-Cyberduck', 'Get-dnGrep', 'Get-Evergreen', 
               'Get-FileZilla', 'Get-FoxitReader', 'Get-GitforWindows', 'Get-GitHubRelease', 
               'Get-Good', 'Get-GoogleChrome', 'Get-Greenshot', 'Get-Handbrake', 
